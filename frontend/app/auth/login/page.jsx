...
// import { useState } from "react";
// import { useRouter } from "next/navigation";
// import { loginRequest, loginRequestDebug } from "../../../lib/api";
...
//         ? await loginRequestDebug(email, password)
...
//             className="w-4 h-4 rounded border-white/30 bg-black/40 text-purple-500 focus:ring-purple-500"
//           />
//           <span className="text-sm text-gray-400">Debug Mode (Check terminal for logs)</span>
//         </label>
//       </div>
//     </motion.div>
//   );
